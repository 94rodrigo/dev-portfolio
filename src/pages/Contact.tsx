                ...
                <div className="mx-auto py-16 sm:py-24 lg:py-10">
                    ...
                    <ul className="mt-4 text-gray-500 list-disc list-inside text-left">
                        <li className="flex items-center">
                            ...
                            <span>{t('contact.email')}: &nbsp; </span><a href="mailto:rodrigoc94@hotmail.com" className="text-indigo-600 hover:text-indigo-800">rodrigoc94@hotmail.com</a>
                        </li>
                        <li className="flex items-center">
                            ...
                            <span>{t('contact.linkedin')}: &nbsp; </span><a href="https://www.linkedin.com/in/rodrigo-de-abreu-costa-a97572b5/" target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:text-indigo-800">linkedin.com/in/rodrigo-de-abreu-costa-a97572b5</a>
                        </li>
                        <li className="flex items-center">
                            ...
                            <span>{t('contact.github')}: &nbsp; </span><a href="https://github.com/94rodrigo" target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:text-indigo-800">github.com/94rodrigo</a>
                        </li>
                    </ul>
                </div>
            </div>
